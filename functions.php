...
function twentytwentyone_styles() {
    ...
    wp_enqueue_script('react', get_stylesheet_directory_uri() . '/scripts/react.production.js', null, null, true);
    wp_enqueue_script('react-dom', get_stylesheet_directory_uri() . '/scripts/react-dom.production.js', null, null, true);
    wp_enqueue_script('lgk-react', get_stylesheet_directory_uri() . '/scripts/lgk-react.js', null, null, true);
}
